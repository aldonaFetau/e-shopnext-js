    ...
    return ( <div className="max-w-[1150px] m-auto flex flex-col gap-2">
        ...
        <div className="flex gap-2 items-center">
            ...
            <div>
               ...
               order.status ==='complete'?<Status text="completed" icon={MdDone} bg="bg-green-200" color="text-green-700"/>:<></> }
            </div>
        </div>
        <div className="flex gap-2 items-center">
        ...
        <div><h2 className="font-semibold mt-4 mb-2">Products ordered</h2>
