...
const  SelectImage:React.FC<SelectImageProps>= ({item, handleFileChange}) => {
    ...
    return ( <div {...getRootProps()} className="border-2 border-slate-400 p-2 border-dashed cursor-pointer font-normal text-slate-400 flex items center justify-center">
