...
interface UserMenuProps{
   currentUser: SafeUser |null //we could directly use the 'User' type from prisma but we changed some of the property types with toISOstring() 
   //so now we create a new folder(types/index.ts) to create an updated User type there (SafeUser)
}
