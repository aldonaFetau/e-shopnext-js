...
const onSubmit: SubmitHandler<FieldValues> = async (data)=>{
   ...
   console.log("imazhi", images)
    ...
    return (
            ...
            //default values props should match with corresponding input ids
    <>
    ...
    />
      <TextArea
        ...
        required     
    />
    <CustomCheckbox id="inStock" register={register} label="This Product is i stock"/>
    <div className="w-full font-medium">
        <div className="mb-2 font-semibold">Select a Category</div>
        <div className="grid grid-cols-2 md:grid-cols-3 max-h-[50vh] overflow-auto gap-3">
            {categories.map((item)=>{
                if(item.label==='All'){
                    return null
                }
    ...
    <div className="w-full flex flex-col flex-wrap gap-4">
        <div className="font-bold">
         Select the available product colors and update their images.
        </div>
    ...
    <Button label={isLoading?'Loading...':'Add Product'} onClick={handleSubmit(onSubmit)} disabled={isLoading}/>              
    </>);
}
